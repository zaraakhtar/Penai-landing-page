    ...
    <div className="flex w-full max-w-[317.33px] flex-col items-center gap-[10px]">
      <div className="relative isolate flex h-[240px] w-full items-center justify-center overflow-hidden rounded-[24px] border border-[#2F2F2F] bg-[linear-gradient(180deg,rgba(27,27,27,1)_0%,rgba(18,18,18,1)_100%)] p-[30px] shadow-[0_30px_70px_rgba(0,0,0,0.55)]">
        <div className="pointer-events-none absolute inset-0 -z-10">
          ...
          {/* rings group (subtle arcs like the Figma card) */}
          <div className="absolute inset-0 opacity-35">
            <div className="absolute left-1/2 bottom-[-290px] h-[420px] w-[740px] -translate-x-1/2 rounded-full border border-white/10" />
            <div className="absolute left-1/2 bottom-[-330px] h-[420px] w-[620px] -translate-x-1/2 rounded-full border border-white/10" />
            <div className="absolute left-1/2 bottom-[-370px] h-[420px] w-[500px] -translate-x-1/2 rounded-full border border-white/10" />
            <div className="absolute left-1/2 bottom-[-410px] h-[420px] w-[380px] -translate-x-1/2 rounded-full border border-white/10" />
          </div>
